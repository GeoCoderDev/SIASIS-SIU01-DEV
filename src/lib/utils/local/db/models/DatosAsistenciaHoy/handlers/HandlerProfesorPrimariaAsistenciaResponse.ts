import {
  ...
  /**
   * Handler para los datos de asistencia específicos del Profesor de Primaria
   */
  export class HandlerProfesorPrimariaAsistenciaResponse {
    private data: ProfesorPrimariaAsistenciaResponse;
  
    /**
     * Constructor que recibe los datos de asistencia
     * @param asistenciaData Datos del profesor de primaria
     */
    ...
    public getHorarioTomaAsistenciaGeneral(): HorarioTomaAsistencia {
      return this.data.HorarioTomaAsistenciaProfesorPrimaria;
    }
    ...
    public getHorarioEscolarPrimaria(): HorarioTomaAsistencia {
      return this.data.HorarioEscolarPrimaria;
    }
    ...
    /**
     * Verifica si la toma de asistencia está activa
    ...
    /**
     * Verifica si el profesor está en horario de trabajo
     ...
     * @returns Los datos completos de asistencia del profesor de primaria
     */
    public getDatosCompletos(): ProfesorPrimariaAsistenciaResponse {
      return this.data;
    }
