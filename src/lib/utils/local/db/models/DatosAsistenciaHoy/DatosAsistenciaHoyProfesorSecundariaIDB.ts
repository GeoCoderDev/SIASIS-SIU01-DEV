...
class DatosAsistenciaHoyProfesorSecundariaIDB extends DatosBaseAsistenciaHoyIDB<ProfesorTutorSecundariaAsistenciaResponse> {
  protected rolPrincipal: RolesSistema = RolesSistema.ProfesorSecundaria;

  /**
   * Obtiene el horario específico del profesor
   */
  ...
  /**
   * Verifica si el profesor tiene horario configurado para hoy
   */
  ...
  /**
   * Verifica si el profesor actualmente está dentro de su horario de trabajo
   */
  ...
  /**
   * Verifica si ya pasó el horario laboral del profesor
   */
  ...
  /**
   * Verifica si aún no es hora de entrada del profesor
   */
...
const datosAsistenciaHoyProfesorSecundariaIDB =
  new DatosAsistenciaHoyProfesorSecundariaIDB();
export default datosAsistenciaHoyProfesorSecundariaIDB;
