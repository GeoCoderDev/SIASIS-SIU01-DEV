...
class DatosAsistenciaHoyProfesorPrimariaIDB extends DatosBaseAsistenciaHoyIDB<ProfesorPrimariaAsistenciaResponse> {
  protected rolPrincipal: RolesSistema = RolesSistema.ProfesorPrimaria;
  ...
  public async obtenerHorarioTomaAsistencia(): Promise<HorarioTomaAsistencia | null> {
    try {
      ...
      return datos?.HorarioTomaAsistenciaProfesorPrimaria || null;
    } catch (error) {
  ...
  /**
   * Obtiene el horario escolar de nivel primaria
   */
  public async obtenerHorarioEscolar(): Promise<HorarioTomaAsistencia | null> {
    try {
      const datos = await this.obtenerDatos();
      return datos?.HorarioEscolarPrimaria || null;
    } catch (error) {
  ...
  /**
   * Verifica si el profesor está dentro del horario para tomar asistencia
   */
...
const datosAsistenciaHoyProfesorPrimariaIDB =
  new DatosAsistenciaHoyProfesorPrimariaIDB();
export default datosAsistenciaHoyProfesorPrimariaIDB;
