...
export class DirectivoModel {
    ...
    try {
      ...
      return new Promise((resolve, reject) => {
        ...
        request.onerror = (event) => {
          reject(
            `Error al obtener todos los directivos: ${
  ...
  public async getById(id: number): Promise<IDirectivo | null> {
    try {
      ...
      return new Promise((resolve, reject) => {
        ...
        request.onerror = (event) => {
          reject(
            `Error al obtener directivo por ID: ${
              (event.target as IDBRequest).error
            }`
          );
        };
  ...
  public async getByUsername(username: string): Promise<IDirectivo | null> {
    try {
      ...
      return new Promise((resolve, reject) => {
        ...
        request.onerror = (event) => {
          reject(
            `Error al obtener directivo por nombre de usuario: ${
              (event.target as IDBRequest).error
            }`
          );
        };
      ...
      console.error(
        `Error al obtener directivo con nombre de usuario ${username}:`,
        error
      );
      throw error;
    }
  ...
  public async getByDNI(dni: string): Promise<IDirectivo | null> {
    try {
      ...
      return new Promise((resolve, reject) => {
        ...
        request.onerror = (event) => {
          reject(
            `Error al obtener directivo por DNI: ${
              (event.target as IDBRequest).error
            }`
          );
        };
   ...
   */
  public async add(
    directivo: Omit<IDirectivo, "Id_Directivo">
  ): Promise<number> {
    try {
      ...
      const existingByUsername = await this.getByUsername(
        directivo.Nombre_Usuario
      );
      if (existingByUsername) {
        throw new Error(
          `Ya existe un directivo con el nombre de usuario ${directivo.Nombre_Usuario}`
        );
      }

      const existingByEmail = await this.getByEmail(
        directivo.Correo_Electronico
      );
      if (existingByEmail) {
        throw new Error(
          `Ya existe un directivo con el correo electrónico ${directivo.Correo_Electronico}`
        );
      }
      ...
      return new Promise((resolve, reject) => {
        ...
        request.onerror = (event) => {
          reject(
            `Error al agregar directivo: ${(event.target as IDBRequest).error}`
          );
        };
      });
    } catch (error) {
  ...
  public async update(directivo: IDirectivo): Promise<void> {
    try {
      ...
      if (directivo.DNI !== existingDirectivo.DNI) {
        ...
        if (
          existingByDNI &&
          existingByDNI.Id_Directivo !== directivo.Id_Directivo
        ) {
          throw new Error(`Ya existe un directivo con el DNI ${directivo.DNI}`);
        }
      }
      ...
      if (directivo.Nombre_Usuario !== existingDirectivo.Nombre_Usuario) {
        ...
        if (
          existingByUsername &&
          existingByUsername.Id_Directivo !== directivo.Id_Directivo
        ) {
          throw new Error(
            `Ya existe un directivo con el nombre de usuario ${directivo.Nombre_Usuario}`
          );
      ...
      if (
        directivo.Correo_Electronico !== existingDirectivo.Correo_Electronico
      ) {
        const existingByEmail = await this.getByEmail(
          directivo.Correo_Electronico
        );
        if (
          existingByEmail &&
          existingByEmail.Id_Directivo !== directivo.Id_Directivo
        ) {
          throw new Error(
            `Ya existe un directivo con el correo electrónico ${directivo.Correo_Electronico}`
          );
      ...
      console.error(
        `Error al actualizar directivo con ID ${directivo.Id_Directivo}:`,
        error
      );
      throw error;
    }
  ...
  public async delete(id: number): Promise<void> {
    try {
      ...
      return new Promise((resolve, reject) => {
        ...
        request.onerror = (event) => {
          reject(
            `Error al eliminar directivo: ${(event.target as IDBRequest).error}`
          );
        };
      });
    } catch (error) {
  ...
  public async getByEmail(email: string): Promise<IDirectivo | null> {
    try {
      ...
      return new Promise((resolve, reject) => {
        ...
        request.onerror = (event) => {
          reject(
            `Error al obtener directivo por correo: ${
              (event.target as IDBRequest).error
            }`
          );
        };
  ...
  public async updateProfilePhoto(
    ...
    try {
      ...
      console.error(
        `Error al actualizar foto de perfil del directivo con ID ${id}:`,
        error
      );
      throw error;
    }
  ...
  public async count(): Promise<number> {
    try {
      ...
      return new Promise((resolve, reject) => {
        ...
        request.onerror = (event) => {
          reject(
            `Error al contar directivos: ${(event.target as IDBRequest).error}`
          );
        };
      });
    } catch (error) {
